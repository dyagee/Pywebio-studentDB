...
client = MongoClient("mongodb+srv://goldseal:<password>@cluster0.ev7dnou.mongodb.net/?retryWrites=true&w=majority")

#call the instance of the database 'school' and collection 'students'
db = client.school
sd = db.students
